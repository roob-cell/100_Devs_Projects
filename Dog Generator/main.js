...
fetch(BREEDS_URL)
    ...
    .then(data => {
        const breedsObjet = data.message                        //Turn .json message into an object
        const breedsArray = Object.keys(breedsObjet)            //Turn the object into an array
        for(let i = 0; i < breedsArray.length; i++) {
            ...
            select.appendChild(option)                          //adds current <option> tag to the select list of options 
        }      
    })
